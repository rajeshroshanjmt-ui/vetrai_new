...
from lfx.io.schema import schema_to_vetrai_inputs
...
def test_schema_to_vetrai_inputs():
    ...
    # Convert schema to Vetrai inputs
    inputs = schema_to_vetrai_inputs(TestSchema)
...
def test_schema_to_vetrai_inputs_invalid_type():
    ...
    with pytest.raises(TypeError, match="Unsupported field type:"):
        schema_to_vetrai_inputs(InvalidSchema)
