...
class TestSecurityFunctions:
    ...
    def test_verify_api_key_with_query_param(self):
        ...
        with patch.dict(os.environ, {"VETRAI_API_KEY": "test-key-123"}):  # pragma: allowlist secret
    ...
    def test_verify_api_key_invalid(self):
        ...
        with patch.dict(os.environ, {"VETRAI_API_KEY": "correct-key"}):  # pragma: allowlist secret
            with pytest.raises(HTTPException) as exc_info:
    ...
    def test_verify_api_key_env_not_set(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            assert "VETRAI_API_KEY environment variable is not set" in exc_info.value.detail
...
class TestServeAppEndpoints:
    ...
    def app_client(self, real_graph_with_async):
        ...
        # Set up test API key
        with patch.dict(os.environ, {"VETRAI_API_KEY": "test-api-key"}):  # pragma: allowlist secret
    ...
    def test_run_endpoint_success(self, app_client):
        ...
        with (
            patch.dict(os.environ, {"VETRAI_API_KEY": "test-api-key"}),  # pragma: allowlist secret
