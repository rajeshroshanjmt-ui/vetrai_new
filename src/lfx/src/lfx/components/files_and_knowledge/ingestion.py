...
from vetrai.services.auth.utils import decrypt_api_key, encrypt_api_key
...
class KnowledgeIngestionComponent(Component):
    """Create or append to Vetrai Knowledge from a DataFrame."""

    # ------ UI metadata ---------------------------------------------------
    display_name = "Knowledge Ingestion"
    description = "Create or update knowledge in Vetrai."
    icon = "upload"
            ...
            default_factory=lambda: {
                "data": {
                    "node": {
                        ...
                        "description": "Create new knowledge in Vetrai.",
