...
class SaveToFileComponent(Component):
    ...
    documentation: str = "https://docs.vetrai.org/write-file"
    icon = "file-text"
    name = "SaveToFile"
    ...
    async def _upload_file(self, file_path: Path) -> None:
        ...
        from vetrai.api.v2.files import upload_user_file
    ...
    async def _save_to_aws(self) -> Message:
        ...
        if not bucket_name:
            msg = (
                ...
                "or set VETRAI_OBJECT_STORAGE_BUCKET_NAME environment variable."
            )
            raise ValueError(msg)
