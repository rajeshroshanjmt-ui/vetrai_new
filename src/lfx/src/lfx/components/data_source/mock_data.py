...
class MockDataGeneratorComponent(Component):
    ...
    Vetrai output types: Message (text), Data (JSON), and DataFrame (tabular data).
    ...
    - Development and debugging of Vetrai components
    """
    ...
    def generate_dataframe_output(self) -> DataFrame:
        ...
        Returns:
            DataFrame: A Vetrai DataFrame with sample data (50 records)
        """
        try:
    ...
    def _generate_dataframe(self, record_count: int) -> DataFrame:
        ...
        Returns:
            DataFrame: A Vetrai DataFrame with sample data
        """
        try:
            import pandas as pd
            ...
            try:
                ...
                # Return as DataFrame wrapper (Vetrai will handle the display)
        ...
        try:
            ...
            # CRITICAL: Use DataFrame wrapper from Vetrai
            ...
            self.log(error_msg)
            # DO NOT set self.status when returning DataFrames - it interferes with display
            # Return a fallback DataFrame with error info using Vetrai wrapper
            try:
