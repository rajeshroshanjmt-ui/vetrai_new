...
USER_AGENT = None
# Check if vetrai is installed using importlib.util.find_spec(name))
if importlib.util.find_spec("vetrai"):
    vetrai_installed = True
    USER_AGENT = get_user_agent()
else:
    vetrai_installed = False
    USER_AGENT = "lfx"
...
class URLComponent(Component):
    ...
    documentation: str = "https://docs.vetrai.org/url"
