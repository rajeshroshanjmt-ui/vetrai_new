...
from lfx.io.schema import flatten_schema, schema_to_vetrai_inputs
...
class MCPToolsComponent(ComponentWithCache):
    ...
    documentation: str = "https://docs.vetrai.org/mcp-tools"
    icon = "Mcp"
    name = "MCPTools"
    ...
    async def _validate_schema_inputs(self, tool_obj) -> list[InputTypes]:
        ...
        try:
            ...
            schema_inputs = schema_to_vetrai_inputs(input_schema)
    ...
    async def update_tool_list(self, mcp_server_value=None):
        ...
        try:
            ...
            try:
                from vetrai.api.v2.mcp import get_server
                from vetrai.services.database.models.user.crud import get_user_by_id

                from lfx.services.deps import get_settings_service
            except ImportError as e:
                msg = (
                    "Vetrai MCP server functionality is not available. "
                    "This feature requires the full Vetrai installation."
                )
    ...
    def get_inputs_for_all_tools(self, tools: list) -> dict:
        ...
        for tool in tools:
            ...
            try:
                ...
                input_schema = create_input_schema_from_json_schema(flat_schema)
                vetrai_inputs = schema_to_vetrai_inputs(input_schema)
                inputs[tool.name] = vetrai_inputs
    ...
    async def build_output(self) -> DataFrame:
        ...
        try:
            ...
            if self.tool != "":
                # Set session context for persistent MCP sessions using Vetrai session ID
    ...
    def _get_session_context(self) -> str | None:
        """Get the Vetrai session ID for MCP session caching."""
