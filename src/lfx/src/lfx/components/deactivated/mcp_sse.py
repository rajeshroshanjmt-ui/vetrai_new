...
class MCPSse(Component):
    ...
    description = "Connects to an MCP server over SSE and exposes it's tools as vetrai tools to be used by an Agent."
    documentation: str = "https://docs.vetrai.org/components-custom-components"
    icon = "code"
    name = "MCPSse"
    legacy = True
