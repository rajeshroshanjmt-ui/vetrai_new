...
async def serve_command(
    ...
    *,
    ...
    try:
        api_key = get_api_key()
        verbose_print("✓ VETRAI_API_KEY is configured")
    except ValueError as e:
        typer.echo(f"✗ {e}", err=True)
        typer.echo("Set the VETRAI_API_KEY environment variable before serving.", err=True)
    ...
    os.environ["VETRAI_PRETTY_LOGS"] = "false"
