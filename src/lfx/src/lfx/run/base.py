"""Core run functionality for executing Vetrai graphs."""
...
async def run_flow(
    ...
    *,
    ...
    """Execute a Vetrai graph script or JSON flow and return the result.

    This function analyzes and executes either a Python script containing a Vetrai graph,
