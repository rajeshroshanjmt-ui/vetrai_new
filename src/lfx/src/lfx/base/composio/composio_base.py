...
class ComposioBaseComponent(Component):
    ...
    def _validate_schema_inputs(self, action_key: str) -> list[InputTypes]:
        """Convert the JSON schema for *action_key* into Vetrai input objects."""
        ...
        try:
            ...
            # Additional safety check before calling schema_to_vetrai_inputs
            ...
            result = schema_to_vetrai_inputs(input_schema)
