    ...
    def validate_value(cls, v: Any, _info):
        ...
        if not isinstance(v, list):
            msg = (
                ...
                "- A Data object (Vetrai's internal data structure)\n"
            )
        ...
        for i, item in enumerate(v):
            if not isinstance(item, dict | Data):
                msg = (
                    ...
                    "- A Data object (Vetrai's internal data structure for passing data between components)\n"
...
class MessageInput(StrInput, InputTraceMixin):
    ...
    def _validate_value(v: Any, _info):
        ...
        if isinstance(v, Message):
            # If it's from a different module (e.g., vetrai.schema.Message),
...
class MessageTextInput(StrInput, MetadataTraceMixin, InputTraceMixin, ToolModeMixin):
    """Represents a text input component for the Vetrai system.

    This component is used to handle text inputs in the Vetrai system.
