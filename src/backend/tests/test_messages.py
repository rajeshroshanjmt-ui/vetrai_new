...
from vetrai.schema.content_block import ContentBlock
from vetrai.schema.content_types import TextContent, ToolContent
from vetrai.schema.message import Message
from vetrai.schema.properties import Properties, Source

# Assuming you have these imports available
from vetrai.services.database.models.message import MessageCreate, MessageRead
from vetrai.services.database.models.message.model import MessageTable
from vetrai.services.deps import session_scope
from vetrai.services.tracing.utils import convert_to_langchain_type
