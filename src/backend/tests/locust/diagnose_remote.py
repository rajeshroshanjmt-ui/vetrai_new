#!/usr/bin/env python3
"""Diagnostic tool for remote Vetrai instances.
...
def main():
    parser = argparse.ArgumentParser(description="Diagnose remote Vetrai instance")
    parser.add_argument("--host", required=True, help="Vetrai host URL")
    ...
    print(f"🔍 Diagnosing Vetrai instance: {args.host}")
    print("=" * 60)
    ...
    if not connectivity_results["reachable"]:
        ...
        print("❌ Health check failed - Vetrai may not be running properly")
