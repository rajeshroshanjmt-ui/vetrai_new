...
class TestTelemetryPayloadValidation:
    ...
    def test_component_inputs_payload_creation_and_serialization(self):
        ...
        from vetrai.services.telemetry.schema import ComponentInputsPayload
...
class TestComponentInputTelemetry:
    ...
    def test_component_payload_with_run_id_integration(self):
        ...
        from vetrai.services.telemetry.schema import ComponentInputsPayload, ComponentPayload
