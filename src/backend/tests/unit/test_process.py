...
from vetrai.services.deps import get_session_service
from vetrai.services.utils import register_all_service_factories
...
def test_apply_tweaks_code_override_prevention():
    ...
    from vetrai.processing.process import apply_tweaks
    ...
    # Capture log output
    with patch("vetrai.processing.process.logger") as mock_logger:
