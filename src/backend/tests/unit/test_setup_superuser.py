...
from vetrai.services.utils import teardown_superuser
...
# @patch("vetrai.services.deps.get_session")
# @patch("vetrai.services.utils.create_super_user")
# @patch("vetrai.services.deps.get_settings_service")
# # @patch("vetrai.services.utils.verify_password")
...
async def test_create_super_user_race_condition():
    ...
    with (
        patch("vetrai.services.auth.utils.get_user_by_username", mock_get_user_by_username),
        patch("vetrai.services.auth.utils.get_password_hash", mock_get_password_hash),
        patch("vetrai.services.database.models.user.model.User") as mock_user_class,
    ):
...
async def test_create_super_user_race_condition_no_user_found():
    ...
    with (
        patch("vetrai.services.auth.utils.get_user_by_username", mock_get_user_by_username),
        patch("vetrai.services.auth.utils.get_password_hash", mock_get_password_hash),
        patch("vetrai.services.database.models.user.model.User", return_value=mock_user),
...
async def test_create_super_user_concurrent_workers():
    ...
    with patch("vetrai.services.auth.utils.get_user_by_username", mock_get_user_by_username):
