...
class TestConstants:
    ...
    def test_vetrai_assistant_flow_should_be_string(self):
        """VETRAI_ASSISTANT_FLOW should be a non-empty string."""
        assert isinstance(VETRAI_ASSISTANT_FLOW, str)
        assert len(VETRAI_ASSISTANT_FLOW) > 0
