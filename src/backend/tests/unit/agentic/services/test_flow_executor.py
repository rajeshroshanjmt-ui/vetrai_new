...
from vetrai.agentic.services.flow_executor import (
    execute_flow_file,
    execute_flow_file_streaming,
    extract_response_text,
)
from vetrai.agentic.services.flow_preparation import (
...
from vetrai.agentic.services.helpers.event_consumer import parse_event_data
...
class TestInjectModelIntoFlow:
    ...
    def test_should_inject_model_into_agent_node(self):
        ...
        with patch("vetrai.agentic.services.flow_preparation.get_provider_config") as mock_config:
...
class TestExecuteFlowFile:
    ...
    async def test_should_execute_flow_with_model_injection(self):
        ...
        with (
            patch(
                "vetrai.agentic.services.flow_executor.resolve_flow_path",
                return_value=(Path("/fake/path/test.json"), "json"),
            ),
            patch(
                "vetrai.agentic.services.flow_executor.load_graph_for_execution",
...
class TestLoadAndPrepareFlow:
    ...
    def test_should_inject_model_when_provider_and_model_specified(self):
        ...
        with patch(
            "vetrai.agentic.services.flow_preparation.inject_model_into_flow",
...
class TestExecuteFlowFileStreaming:
    ...
    async def test_should_yield_token_and_end_events(self):
        ...
        with (
            ...
            patch("vetrai.agentic.services.flow_executor.create_default_event_manager"),
        ):
