...
and validating that the code is a valid Vetrai component.
"""

from vetrai.agentic.helpers.code_extraction import (
    _find_code_blocks,
    _find_unclosed_code_block,
    extract_python_code,
)
from vetrai.agentic.helpers.validation import validate_component_code

# Sample valid Vetrai component code
VALID_COMPONENT_CODE = """from vetrai.custom import Component
from vetrai.io import MessageTextInput, Output
from vetrai.schema.message import Message
...
INCOMPLETE_COMPONENT_CODE = """from vetrai.custom import Component
from vetrai.io import MessageTextInput, Output
...
# Invalid syntax code
INVALID_SYNTAX_CODE = """from vetrai.custom import Component
...
class TestExtractPythonCode:
    ...
    def test_extract_from_closed_python_block(self):
        ...
        assert "from vetrai.custom import Component" in result
...
```"""
    ...
    def test_handles_code_with_special_characters(self):
        ...
        code_with_specials = """from vetrai.custom import Component
...
class TestValidateComponentCode:
    ...
    def test_validates_valid_component(self):
        """Should validate correct Vetrai component code."""
    ...
    def test_fails_for_non_component_code(self):
        """Should fail validation for code that's not a Vetrai component."""
...
Based on your request, I'll create a custom Vetrai component that performs sentiment analysis.
This component will:
1. Take text input
...
class TestEdgeCases:
    ...
    def test_handles_unicode_in_code(self):
        ...
        unicode_code = """from vetrai.custom import Component
