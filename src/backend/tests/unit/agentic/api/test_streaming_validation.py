...
import pytest
from vetrai.agentic.helpers.code_extraction import extract_python_code
from vetrai.agentic.helpers.sse import (
...
INVALID_COMPONENT_CODE = """from vetrai.custom import Component
from vetrai.io import MessageTextInput, Output
...
class TestStreamingValidationFlow:
    ...
    async def test_valid_code_first_try_returns_validated(self):
        ...
        with (
            patch(
                "vetrai.agentic.services.assistant_service.classify_intent",
                side_effect=_mock_intent_classification("generate_component"),
            ),
            patch(
                "vetrai.agentic.services.assistant_service.execute_flow_file_streaming",
    ...
    async def test_no_code_in_response_returns_as_is(self):
        ...
        text_only_response = {"result": "Vetrai is a visual flow builder for LLM applications."}
...
class TestNonStreamingValidation:
    ...
    async def test_non_streaming_valid_code_returns_validated(self):
        ...
        with patch(
            "vetrai.agentic.services.assistant_service.execute_flow_file",
