"""Tests for VetraiAssistant flow.
...
from vetrai.agentic.flows.vetrai_assistant import (
    ASSISTANT_PROMPT,
    _build_model_config,
    get_graph,
)
...
class TestGetGraph:
    ...
    def test_should_create_graph_with_default_provider(self):
        ...
        with (
            patch("vetrai.agentic.flows.vetrai_assistant.ChatInput") as mock_chat_input,
            patch("vetrai.agentic.flows.vetrai_assistant.ChatOutput") as mock_chat_output,
            patch("vetrai.agentic.flows.vetrai_assistant.LanguageModelComponent") as mock_llm,
            patch("vetrai.agentic.flows.vetrai_assistant.Graph"),
        ):
    ...
    def test_should_use_provided_provider_and_model(self):
        ...
        with (
            patch("vetrai.agentic.flows.vetrai_assistant.ChatInput"),
            patch("vetrai.agentic.flows.vetrai_assistant.ChatOutput"),
            patch("vetrai.agentic.flows.vetrai_assistant.LanguageModelComponent") as mock_llm,
            patch("vetrai.agentic.flows.vetrai_assistant.Graph"),
        ):
            mock_llm_instance = MagicMock()
    ...
    def test_should_configure_chat_input(self):
        ...
        with (
            patch("vetrai.agentic.flows.vetrai_assistant.ChatInput") as mock_chat_input,
            patch("vetrai.agentic.flows.vetrai_assistant.ChatOutput"),
            patch("vetrai.agentic.flows.vetrai_assistant.LanguageModelComponent"),
            patch("vetrai.agentic.flows.vetrai_assistant.Graph"),
        ):
    ...
    def test_should_create_graph_with_start_and_end(self):
        ...
        with (
            ...
            patch("vetrai.agentic.flows.vetrai_assistant.ChatOutput") as mock_chat_output,
            patch("vetrai.agentic.flows.vetrai_assistant.LanguageModelComponent"),
            patch("vetrai.agentic.flows.vetrai_assistant.Graph") as mock_graph_class,
        ):
...
class TestAssistantPrompt:
    ...
    def test_should_contain_vetrai_references(self):
        """Should contain Vetrai documentation references."""
        assert "vetrai" in ASSISTANT_PROMPT.lower()
        assert "docs.vetrai.org" in ASSISTANT_PROMPT

    def test_should_contain_code_requirements(self):
        """Should contain code requirements for components."""
        assert "lfx.custom" in ASSISTANT_PROMPT or "vetrai.custom" in ASSISTANT_PROMPT
