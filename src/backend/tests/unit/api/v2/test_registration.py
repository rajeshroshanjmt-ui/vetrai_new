...
from vetrai.api.v2.registration import (
    RegisterRequest,
    RegisterResponse,
...
class TestHelperFunctions:
    ...
    @patch("vetrai.api.v2.registration.REGISTRATION_FILE")
    ...
    @patch("vetrai.api.v2.registration.REGISTRATION_FILE")
    @patch("vetrai.api.v2.registration.logger")
    ...
    @patch("vetrai.api.v2.registration._ensure_registration_file")
    @patch("vetrai.api.v2.registration.load_registration")
    @patch("vetrai.api.v2.registration.REGISTRATION_FILE")
    @patch("vetrai.api.v2.registration.logger")
...
class TestAPIEndpoints:
    ...
    @pytest.mark.asyncio
    @patch("vetrai.api.v2.registration.save_registration")
...
class TestIntegration:
    ...
    def test_full_registration_flow(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("vetrai.api.v2.registration.REGISTRATION_FILE", test_file)
