...
from vetrai.exceptions.api import APIException, ExceptionBody
...
def test_api_exception():
    ...
    with (
        patch(
            "vetrai.services.database.models.flow.utils.get_outdated_components",
            return_value=mock_outdated_components,
        ),
        patch("vetrai.api.utils.get_suggestion_message", return_value=mock_suggestion_message),
        patch(
            "vetrai.services.database.models.flow.utils.get_components_versions",
