...
class TestAPIRequestSSRFProtection:
    ...
    async def test_ssrf_protection_enabled_blocks_localhost(self, component):
        ...
        with (
            patch.dict(os.environ, {"VETRAI_SSRF_PROTECTION_ENABLED": "true"}),
    ...
    async def test_ssrf_protection_enabled_blocks_private_networks(self, component):
        ...
        with patch.dict(os.environ, {"VETRAI_SSRF_PROTECTION_ENABLED": "true"}):
    ...
    async def test_ssrf_protection_allows_public_urls(self, component):
        ...
        public_urls = [
            ...
            "https://api.github.com/repos/vetrai-ai/vetrai",
    ...
    async def test_ssrf_protection_allowlist_bypass(self, component):
        ...
        with (
            patch.dict(
                os.environ,
                {"VETRAI_SSRF_PROTECTION_ENABLED": "true", "VETRAI_SSRF_ALLOWED_HOSTS": "internal.company.local"},
            ),
            respx.mock,
        ):
    ...
    async def test_ssrf_protection_allowlist_cidr(self, component):
        ...
        with (
            patch.dict(
                os.environ,
                {"VETRAI_SSRF_PROTECTION_ENABLED": "true", "VETRAI_SSRF_ALLOWED_HOSTS": "192.168.1.0/24"},
            ),
            respx.mock,
        ):
    ...
    async def test_ssrf_protection_warn_only_mode(self, component):
        ...
        with patch.dict(os.environ, {"VETRAI_SSRF_PROTECTION_ENABLED": "true"}), respx.mock:
