...
class TestAllModulesImportable:
    ...
    def test_backward_compatibility_imports(self):
        ...
        traditional_imports = [
            ("vetrai.components.openai", "OpenAIModelComponent"),
            ("vetrai.components.anthropic", "AnthropicModelComponent"),
            ("vetrai.components.data", "APIRequestComponent"),
            ("vetrai.components.models_and_agents", "AgentComponent"),
            ("vetrai.components.helpers", "CalculatorComponent"),
        ]
