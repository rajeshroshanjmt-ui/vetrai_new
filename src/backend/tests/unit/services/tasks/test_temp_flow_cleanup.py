...
import pytest
from vetrai.services.database.models.flow import Flow as FlowTable
...
from vetrai.services.task.temp_flow_cleanup import (
    CleanupWorker,
...
async def test_cleanup_worker_run_with_exception(mocker):
    ...
    mock_logger = mocker.patch("vetrai.services.task.temp_flow_cleanup.logger")
