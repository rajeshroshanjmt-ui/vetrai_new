...
import pytest
from vetrai.services.database.models.variable.model import VariableUpdate
from vetrai.services.deps import get_settings_service
from vetrai.services.variable.constants import CREDENTIAL_TYPE
from vetrai.services.variable.service import DatabaseVariableService
...
async def test_initialize_user_variables__not_found_variable(service, session: AsyncSession):
    with patch("vetrai.services.variable.service.DatabaseVariableService.create_variable") as m:
...
async def test_get_all_decrypted_variables__decryption_failure(service, session: AsyncSession):
    ...
    with patch("vetrai.services.auth.utils.decrypt_api_key") as mock_decrypt:
