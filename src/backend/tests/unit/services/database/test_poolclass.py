...
Issue: https://github.com/vetrai-ai/vetrai/issues/10231
PR: https://github.com/vetrai-ai/vetrai/pull/10232
...
class TestBuggyCode:
    ...
    def test_buggy_code_crashes_with_nullpool(self):
        ...
        When users set VETRAI_DB_CONNECTION_SETTINGS={"poolclass": "NullPool"},
