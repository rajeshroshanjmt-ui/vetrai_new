...
import pytest
from vetrai.utils.mustache_security import safe_mustache_render, validate_mustache_template
...
class TestMustacheSecurity:
    ...
    def test_safe_render_multiple_variables(self):
        ...
        variables = {"greeting": "Hello", "name": "Alice", "place": "Vetrai"}
        result = safe_mustache_render(template, variables)
        assert result == "Hello Alice, welcome to Vetrai!"
