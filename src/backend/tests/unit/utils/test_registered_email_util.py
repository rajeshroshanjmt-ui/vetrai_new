...
import pytest
from vetrai.services.telemetry.schema import EmailPayload
from vetrai.utils.registered_email_util import _RegisteredEmailCache, get_email_model
...
class TestGetEmailModel:
    ...
    def test_get_email_model_success(self):
        ...
        with patch("vetrai.utils.registered_email_util.load_registration") as mock_load_registration:
