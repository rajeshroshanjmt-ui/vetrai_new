...
from vetrai.initial_setup.constants import STARTER_FOLDER_NAME
...
from vetrai.interface.components import get_and_cache_all_types_dict
from vetrai.services.auth.utils import create_super_user
from vetrai.services.database.models import Flow
from vetrai.services.database.models.folder.model import Folder
from vetrai.services.deps import get_settings_service, session_scope
...
@pytest.mark.parametrize(
    ...
    [
        (
            "https://github.com/vetrai-ai/vetrai-bundles",
            "https://github.com/vetrai-ai/vetrai-bundles/archive/refs/heads/main.zip",
        ),
        (
            "https://github.com/vetrai-ai/vetrai-bundles/",
            "https://github.com/vetrai-ai/vetrai-bundles/archive/refs/heads/main.zip",
        ...
        (
            "https://github.com/vetrai-ai/vetrai-bundles.git",
            "https://github.com/vetrai-ai/vetrai-bundles/archive/refs/heads/main.zip",
        ),
        (
            "https://github.com/vetrai-ai/vetrai-bundles/tree/some.branch-0_1",
            "https://github.com/vetrai-ai/vetrai-bundles/archive/refs/heads/some.branch-0_1.zip",
        ),
        (
            "https://github.com/vetrai-ai/vetrai-bundles/tree/some/branch",
            "https://github.com/vetrai-ai/vetrai-bundles/archive/refs/heads/some/branch.zip",
        ),
        (
            "https://github.com/vetrai-ai/vetrai-bundles/tree/some/branch/",
            "https://github.com/vetrai-ai/vetrai-bundles/archive/refs/heads/some/branch.zip",
        ...
        (
            "https://github.com/vetrai-ai/vetrai-bundles/releases/tag/v1.0.0-0_1",
            "https://github.com/vetrai-ai/vetrai-bundles/archive/refs/tags/v1.0.0-0_1.zip",
        ),
        (
            "https://github.com/vetrai-ai/vetrai-bundles/releases/tag/foo/v1.0.0",
            "https://github.com/vetrai-ai/vetrai-bundles/archive/refs/tags/foo/v1.0.0.zip",
        ),
        (
            "https://github.com/vetrai-ai/vetrai-bundles/releases/tag/foo/v1.0.0/",
            "https://github.com/vetrai-ai/vetrai-bundles/archive/refs/tags/foo/v1.0.0.zip",
        ...
        (
            "https://github.com/vetrai-ai/vetrai-bundles/commit/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9",
            "https://github.com/vetrai-ai/vetrai-bundles/archive/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9.zip",
        ),
        (
            "https://github.com/vetrai-ai/vetrai-bundles/commit/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9/",
            "https://github.com/vetrai-ai/vetrai-bundles/archive/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9.zip",
...
async def test_load_bundles_from_urls():
    ...
    try:
        ...
        assert "vetrai-bundles-68428ce16729a385fe1bcc0f1ec91fd5f5f420b9/components" in components_paths[0]
...
def set_fs_flows_polling_interval():
    os.environ["VETRAI_FS_FLOWS_POLLING_INTERVAL"] = "100"
    yield
    os.unsetenv("VETRAI_FS_FLOWS_POLLING_INTERVAL")
...
async def test_sync_flows_from_fs(client: AsyncClient, logged_in_headers):
    ...
    try:
        ...
        from vetrai.services.deps import get_storage_service
...
def profile_pictures_temp_config(monkeypatch):
    ...
    monkeypatch.setenv("VETRAI_CONFIG_DIR", str(config_path))
...
async def test_copy_profile_pictures_source_exists():
    ...
    from vetrai.initial_setup import setup
...
async def test_copy_profile_pictures_handles_missing_config_dir():
    ...
    with patch("vetrai.initial_setup.setup.get_storage_service") as mock_storage:
