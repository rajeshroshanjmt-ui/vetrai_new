"""Unit tests for vetrai.core.celery_app module."""
...
class TestMakeCelery:
    ...
    def test_make_celery_creates_celery_instance(self):
        ...
        from vetrai.core.celery_app import make_celery
        ...
        with patch.dict("sys.modules", {"vetrai.core.celeryconfig": mock_config}):
            # Act - Create a real Celery instance
            celery_app = make_celery("test_app", "vetrai.core.celeryconfig")
    ...
    def test_make_celery_sets_task_routes(self):
        ...
        with patch.dict("sys.modules", {"vetrai.core.celeryconfig": mock_config}):
            app1 = make_celery("app1", "vetrai.core.celeryconfig")
            app2 = make_celery("app2", "vetrai.core.celeryconfig")
    ...
    def test_make_celery_with_different_configs(self):
        ...
        with patch.dict("sys.modules", {"vetrai.core.celeryconfig": mock_config1}):
            app1 = make_celery("test_app", "vetrai.core.celeryconfig")
            assert app1.conf.broker_url == "redis://test1:6379/0"

        with patch.dict("sys.modules", {"vetrai.core.celeryconfig": mock_config2}):
            app2 = make_celery("test_app", "vetrai.core.celeryconfig")
    ...
    def test_make_celery_error_handling(self):
        ...
        with patch("vetrai.core.celery_app.Celery") as mock_celery_class:
    ...
    def test_make_celery_configuration_application(self):
        ...
        from vetrai.core.celery_app import celery_app
