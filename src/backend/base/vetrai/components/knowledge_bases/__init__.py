"""Vetrai knowledge bases module - forwards to lfx.components.files_and_knowledge.
...
# This allows imports like: import vetrai.components.knowledge_bases.ingestion
_redirected_submodules = {
    "vetrai.components.knowledge_bases.ingestion": "lfx.components.files_and_knowledge.ingestion",
    "vetrai.components.knowledge_bases.retrieval": "lfx.components.files_and_knowledge.retrieval",
}
