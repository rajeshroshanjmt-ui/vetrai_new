...
def create_vetrai_progress(*, verbose: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Vetrai initialization steps."""
    progress = ProgressIndicator(verbose=verbose)

    # Define the initialization steps matching the order in main.py
    steps = [
        ("Initializing Vetrai", "Setting up basic configuration"),
        ...
        ("Launching Vetrai", "Starting server and final setup"),
    ]
...
def create_vetrai_shutdown_progress(*, verbose: bool = False, multiple_workers: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Vetrai shutdown steps."""
    progress = ProgressIndicator(verbose=verbose)
