...
from vetrai.services.database.models.flow.model import FlowBase


def get_flow(url: str, flow_id: str):
    """Get the details of a flow from Vetrai.

    Args:
        url (str): The host URL of Vetrai.
        port (int): The port number of Vetrai.
