...
from vetrai.api.utils import CurrentActiveUser, DbSession, extract_global_variables_from_headers, parse_value
from vetrai.api.v1.schemas import (
    ConfigResponse,
...
from vetrai.events.event_manager import create_stream_tokens_event_manager
from vetrai.exceptions.api import APIException, InvalidChatInputError
from vetrai.exceptions.serialization import SerializationError
from vetrai.helpers.flow import get_flow_by_id_or_endpoint_name
from vetrai.interface.initialize.loading import update_params_with_load_from_db_fields
from vetrai.processing.process import process_tweaks, run_graph_internal
from vetrai.schema.graph import Tweaks
from vetrai.services.auth.utils import (
    api_key_security,
    get_current_active_user,
    get_current_user_for_sse,
    get_webhook_user,
)
from vetrai.services.cache.utils import save_uploaded_file
from vetrai.services.database.models.flow.model import Flow, FlowRead
from vetrai.services.database.models.flow.utils import get_all_webhook_components_in_flow
from vetrai.services.database.models.user.model import User, UserRead
from vetrai.services.deps import get_session_service, get_settings_service, get_telemetry_service
from vetrai.services.event_manager import create_webhook_event_manager, webhook_event_manager
from vetrai.services.telemetry.schema import RunPayload
from vetrai.utils.compression import compress_response
from vetrai.utils.version import get_version_info

if TYPE_CHECKING:
    from vetrai.events.event_manager import EventManager
...
async def _run_flow_internal(
    *,
    ...
    # Extract request-level variables from headers with prefix X-VETRAI-GLOBAL-VAR-*
...
async def simplified_run_flow(
    *,
    ...
    Notes:
        ...
        - Extracts global variables from HTTP headers with prefix X-VETRAI-GLOBAL-VAR-*
...
# get endpoint to return version of vetrai
@router.get("/version")
