...
from vetrai.api.utils import CurrentActiveUser, DbSession, ValidatedFileName
from vetrai.api.v1.schemas import UploadFileResponse
...
def _get_allowed_profile_picture_folders(settings_service: SettingsService) -> set[str]:
    ...
    defaults {"People", "Space"} shipped with Vetrai.
    """
    allowed: set[str] = set()
    try:
