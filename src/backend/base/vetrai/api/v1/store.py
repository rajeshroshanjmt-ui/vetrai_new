...
from vetrai.api.utils import CurrentActiveUser, check_vetrai_version
from vetrai.services.auth import utils as auth_utils
from vetrai.services.deps import get_settings_service, get_store_service
from vetrai.services.store.exceptions import CustomError
from vetrai.services.store.schema import (
...
async def share_component(
    ...
    try:
        await check_vetrai_version(component)
