...
from vetrai.api.utils import extract_global_variables_from_headers
from vetrai.api.v1.endpoints import consume_and_yield, run_flow_generator, simple_run_flow
from vetrai.api.v1.schemas import SimplifiedAPIRequest
...
from vetrai.schema import (
    OpenAIErrorResponse,
    OpenAIResponsesRequest,
    OpenAIResponsesResponse,
    OpenAIResponsesStreamChunk,
)
from vetrai.schema.content_types import ToolContent
from vetrai.services.auth.utils import api_key_security
from vetrai.services.database.models.flow.model import FlowRead
from vetrai.services.database.models.user.model import UserRead
from vetrai.services.deps import get_telemetry_service
from vetrai.services.telemetry.schema import RunPayload
from vetrai.services.telemetry.service import TelemetryService
    ...
    *,
    ...
    if stream:
        ...
        async def openai_stream_generator() -> AsyncGenerator[str, None]:
            """Convert Vetrai events to OpenAI Responses API streaming format."""
...
async def create_response(
    ...
    the input through the specified Vetrai flow.
    ...
    # Extract global variables from X-VETRAI-GLOBAL-VAR-* headers
