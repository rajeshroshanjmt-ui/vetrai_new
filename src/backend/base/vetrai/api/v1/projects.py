...
from vetrai.api.utils import CurrentActiveUser, DbSession, cascade_delete_flow, custom_params, remove_api_keys
from vetrai.api.utils.mcp.config_utils import validate_mcp_server_for_project
from vetrai.api.v1.auth_helpers import handle_auth_settings_update
from vetrai.api.v1.flows import create_flows
...
from vetrai.api.v1.schemas import FlowListCreate
from vetrai.api.v2.mcp import update_server
from vetrai.helpers.flow import generate_unique_flow_name
from vetrai.helpers.folders import generate_unique_folder_name
from vetrai.initial_setup.constants import ASSISTANT_FOLDER_NAME, STARTER_FOLDER_NAME
from vetrai.services.auth.mcp_encryption import encrypt_auth_settings
from vetrai.services.database.models.api_key.crud import create_api_key
from vetrai.services.database.models.api_key.model import ApiKeyCreate
from vetrai.services.database.models.flow.model import Flow, FlowCreate, FlowRead
from vetrai.services.database.models.folder.constants import DEFAULT_FOLDER_NAME
from vetrai.services.database.models.folder.model import (
    Folder,
    FolderCreate,
    FolderRead,
    FolderReadWithFlows,
...
from vetrai.services.database.models.folder.pagination_model import FolderWithPaginatedFlows
from vetrai.services.deps import get_service, get_settings_service, get_storage_service
...
async def delete_project(
    *,
    ...
    # Prevent deletion of the Vetrai Assistant folder
