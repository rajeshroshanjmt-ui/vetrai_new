...
from vetrai.logging import logger
from vetrai.services.deps import get_settings_service, get_shared_component_cache_service, get_storage_service
    ...
    async def check_server(server_name: str) -> dict:
        ...
        try:
            ...
            try:
                ...
                from vetrai.services.database.models.variable.model import Variable
