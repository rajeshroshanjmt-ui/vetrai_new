...
from vetrai.api.v1.schemas import RunResponse
from vetrai.api.v2.converters import (
    create_error_response,
    parse_flat_inputs,
    run_response_to_workflow_response,
)
from vetrai.api.v2.workflow_reconstruction import reconstruct_workflow_response_from_job_id
from vetrai.exceptions.api import (
...
from vetrai.services.deps import get_job_service, get_task_service
...
async def execute_sync_workflow(
    ...
    # Headers with prefix X-VETRAI-GLOBAL-VAR-* are extracted and made available to components
