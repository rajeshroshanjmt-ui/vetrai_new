...
from vetrai.services.database.models.message.model import MessageRead, MessageTable
...
async def aadd_messages(messages: Message | list[Message], flow_id: str | UUID | None = None):
    ...
    # Check if all messages are Message instances (either from vetrai or lfx)
    for message in messages:
        # Accept Message instances from both vetrai and lfx packages
