...
from vetrai.services.schema import ServiceType
...
if TYPE_CHECKING:
    ...
    from vetrai.services.cache.service import AsyncBaseCacheService, CacheService
    from vetrai.services.chat.service import ChatService
    from vetrai.services.database.service import DatabaseService
    from vetrai.services.session.service import SessionService
    from vetrai.services.state.service import StateService
    from vetrai.services.store.service import StoreService
    from vetrai.services.task.service import TaskService
    from vetrai.services.tracing.service import TracingService
    from vetrai.services.variable.service import VariableService
...
from vetrai.services.job_queue.service import JobQueueService  # noqa: TC001
from vetrai.services.storage.service import StorageService  # noqa: TC001
from vetrai.services.telemetry.service import TelemetryService  # noqa: TC001
...
def get_service(service_type: ServiceType, default=None):
    ...
    if not service_manager.are_factories_registered():
        ...
        from vetrai.services.manager import ServiceManager
...
def get_telemetry_service() -> TelemetryService:
    ...
    """
    from vetrai.services.telemetry.factory import TelemetryServiceFactory
...
def get_tracing_service() -> TracingService:
    ...
    """
    from vetrai.services.tracing.factory import TracingServiceFactory
...
def get_state_service() -> StateService:
    ...
    """
    from vetrai.services.state.factory import StateServiceFactory
...
def get_storage_service() -> StorageService:
    ...
    """
    from vetrai.services.storage.factory import StorageServiceFactory
...
def get_variable_service() -> VariableService:
    ...
    """
    from vetrai.services.variable.factory import VariableServiceFactory
...
def get_db_service() -> DatabaseService:
    ...
    """
    from vetrai.services.database.factory import DatabaseServiceFactory
...
def get_cache_service() -> Union[CacheService, AsyncBaseCacheService]:  # noqa: UP007
    ...
    """
    from vetrai.services.cache.factory import CacheServiceFactory
...
def get_shared_component_cache_service() -> CacheService:
    ...
    Returns:
        The cache service instance.
    """
    from vetrai.services.shared_component_cache.factory import SharedComponentCacheServiceFactory
...
def get_session_service() -> SessionService:
    ...
    """
    from vetrai.services.session.factory import SessionServiceFactory
...
def get_task_service() -> TaskService:
    ...
    """
    from vetrai.services.task.factory import TaskServiceFactory
...
def get_queue_service() -> JobQueueService:
    ...
    from vetrai.services.job_queue.factory import JobQueueServiceFactory
...
def get_job_service():
    ...
    """
    from vetrai.services.jobs.factory import JobServiceFactory
