...
from vetrai.services.database.models.api_key.crud import check_key
from vetrai.services.database.models.user.crud import get_user_by_id, get_user_by_username, update_user_last_login_at
...
if TYPE_CHECKING:
    from vetrai.services.database.models.api_key.model import ApiKey
...
AUTO_LOGIN_WARNING = "In v2.0, VETRAI_SKIP_AUTH_AUTO_LOGIN will be removed. Please update your authentication method."
AUTO_LOGIN_ERROR = (
    "Since v1.5, VETRAI_AUTO_LOGIN requires a valid API key. "
    "Set VETRAI_SKIP_AUTH_AUTO_LOGIN=true to skip this check. "
