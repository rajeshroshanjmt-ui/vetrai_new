...
from vetrai.services.store.exceptions import APIKeyError, FilterError, ForbiddenError
...
from vetrai.services.store.utils import (
...
def get_id_from_search_string(search_string: str) -> str | None:
    ...
    if "www.vetrai.store/store/" in search_string:
...
class StoreService(Service):
    """This is a service that integrates vetrai with the store which is a Directus instance.
