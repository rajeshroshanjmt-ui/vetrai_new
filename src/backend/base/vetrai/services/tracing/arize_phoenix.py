...
from vetrai.services.tracing.base import BaseTracer
...
if TYPE_CHECKING:
    ...
    from vetrai.services.tracing.schema import Log
...
class CollectingSpanProcessor(SpanProcessor):
    ...
    def on_start(self, span, parent_context=None):
        ...
        if span.name in ("Vetrai", "Language Model"):
            span.set_attribute("vetrai.correlation_id", self.correlation_id)
...
class ArizePhoenixTracer(BaseTracer):
    ...
    def __init__(
        ...
        try:
            ...
            self.root_span.set_attribute("vetrai.trace_name", self.trace_name)
            self.root_span.set_attribute("vetrai.trace_type", self.trace_type)
            self.root_span.set_attribute("vetrai.project_name", self.project_name)
            self.root_span.set_attribute("vetrai.trace_id", str(self.trace_id))
            self.root_span.set_attribute("vetrai.session_id", str(self.session_id))
            self.root_span.set_attribute("vetrai.flow_name", self.flow_name)
            self.root_span.set_attribute("vetrai.flow_id", self.flow_id)
