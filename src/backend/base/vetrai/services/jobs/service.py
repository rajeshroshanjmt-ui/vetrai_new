...
from vetrai.services.database.models.jobs.crud import get_job_by_job_id, get_jobs_by_flow_id, update_job_status
from vetrai.services.database.models.jobs.model import Job, JobStatus
...
class JobService(Service):
    ...
    async def execute_with_status(self, job_id: UUID, flow_id: UUID, run_graph_func, *args, **kwargs):
        ...
        try:
            ...
            if exc.args and exc.args[0] == "VETRAI_USER_CANCELLED":
