...
""")
    ...
    url_component.set(urls=["https://vetrai.org/", "https://docs.vetrai.org/"])
    ...
    text_input.set(
        input_value="Use the references above for style to write a new blog/tutorial about Vetrai and AI. "
