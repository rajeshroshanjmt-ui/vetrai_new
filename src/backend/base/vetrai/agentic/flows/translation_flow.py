...
Usage:
    from vetrai.agentic.flows.translation_flow import get_graph
...
- "generate_component": User wants you to CREATE/BUILD/GENERATE a custom Vetrai component for them
...
Examples:
Input: "como criar um componente no vetrai"
Output: {{"translation": "how to create a component in vetrai", "intent": "question"}}
