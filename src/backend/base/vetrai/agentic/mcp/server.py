"""FastMCP server for Vetrai Agentic tools.
...
from vetrai.agentic.mcp.support import replace_none_and_null_with_empty_str
from vetrai.agentic.utils.component_search import (
