import { VETRAI_ACCESS_TOKEN } from "@/constants/constants";
import { cookieManager } from "@/utils/cookie-manager";

/**
 * Get access token from cookies.
 *
 * Note: When VETRAI_ACCESS_HTTPONLY is enabled, this will return null
...
export const customGetAccessToken = () => {
  ...
  return cookieManager.get(VETRAI_ACCESS_TOKEN) ?? null;
};
