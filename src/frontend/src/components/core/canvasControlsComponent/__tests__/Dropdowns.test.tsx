...
jest.mock("@/constants/constants", () => ({
  ...
  DOCS_URL: "https://docs.vetrai.org",
  DESKTOP_URL: "https://desktop.vetrai.org",
}));

jest.mock("@/customization/feature-flags", () => ({
  ENABLE_DATASTAX_VETRAI: false,
}));
...
describe("HelpDropdown", () => {
  ...
  it("opens docs in new tab and navigates to shortcuts", () => {
    ...
    fireEvent.click(
      screen.getByTestId("canvas_controls_dropdown_get_vetrai_desktop"),
    );
    expect(window.open).toHaveBeenCalledWith(
      "https://desktop.vetrai.org",
      "_blank",
    );
  });
});
