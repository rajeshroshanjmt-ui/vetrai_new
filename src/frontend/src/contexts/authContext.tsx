...
export function AuthProvider({ children }): React.ReactElement {
  ...
  function login(
    ...
    cookieManager.set(VETRAI_ACCESS_TOKEN, newAccessToken);
    cookieManager.set(VETRAI_AUTO_LOGIN_OPTION, autoLogin);
    setLocalStorage(VETRAI_ACCESS_TOKEN, newAccessToken);

    if (refreshToken) {
      cookieManager.set(VETRAI_REFRESH_TOKEN, refreshToken);
    }
