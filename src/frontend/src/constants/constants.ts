...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the Vetrai documentation for more information on how to write your own component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "Vetrai: Create, Chain, Communicate.",
...
export const API_PAGE_PARAGRAPH =
  "Your secret Vetrai API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const VETRAI_SUPPORTED_TYPES = new Set([
  "str",
  "bool",
  "float",
  "code",
...
export const VETRAI_CHAT_TITLE = "Vetrai Chat";
...
export const STORE_TITLE = "Vetrai Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your Vetrai API key.";
...
export const VETRAI_ACCESS_TOKEN = "access_token_lf";
export const VETRAI_API_TOKEN = "apikey_tkn_lflw";
export const VETRAI_AUTO_LOGIN_OPTION = "auto_login_lf";
export const VETRAI_REFRESH_TOKEN = "refresh_token_lf";

export const VETRAI_ACCESS_TOKEN_EXPIRE_SECONDS = 60 * 60 - 60 * 60 * 0.1;
export const VETRAI_ACCESS_TOKEN_EXPIRE_SECONDS_ENV =
...
export const IS_AUTO_LOGIN =
  !getEnvVar("VETRAI_AUTO_LOGIN") ||
  String(getEnvVar("VETRAI_AUTO_LOGIN"))?.toLowerCase() !== "false";
...
export const GITHUB_URL = "https://github.com/vetrai/vetrai";
export const TWITTER_URL = "https://x.com/vetrai_ai";
export const DOCS_URL = "https://docs.vetrai.org";
export const DATASTAX_DOCS_URL =
  "https://docs.datastax.com/en/vetrai/index.html";
export const DESKTOP_URL = "https://www.vetrai.org/desktop";
export const BUG_REPORT_URL = "https://github.com/vetrai/vetrai/issues";
