  ...
  useEffect(() => {
    ...
    const isAuthorizedURL = (url) => {
      const authorizedDomains = [
        "https://raw.githubusercontent.com/vetrai/vetrai_examples/main/examples",
        "https://api.github.com/repos/vetrai/vetrai_examples/contents/examples",
        "https://api.github.com/repos/vetrai/vetrai",
        "auto_login",
      ];
    ...
    // Request interceptor to add custom headers and Authorization token
