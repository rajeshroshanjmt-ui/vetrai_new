...
export default function SettingsPage(): JSX.Element {
  ...
  if (!ENABLE_DATASTAX_VETRAI) {
    const vetraiItems = CustomStoreSidebar(true, ENABLE_VETRAI_STORE);
    sidebarNavItems.splice(2, 0, ...vetraiItems);
  }
  ...
  return (
    <PageLayout
      backTo={-1 as To}
      title="Settings"
      description="Manage the general settings for Vetrai."
    >
