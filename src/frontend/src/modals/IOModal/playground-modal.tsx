//import VetraiLogoColor from "@/assets/VetraiLogocolor.svg?react";
...
import { VetraiButtonRedirectTarget } from "@/customization/utils/urls";
...
export default function IOModal({
  ...
  const VetraiButtonClick = () => {
    track("VetraiButtonClick");
    customOpenNewTab(VetraiButtonRedirectTarget());
  };
              ...
              >
                ...
                {sidebarOpen && showPublishOptions && (
                  <div className="absolute bottom-2 left-0 flex w-full flex-col gap-8 border-t border-border px-2 py-4 transition-all">
                    ...
                    <Button
                      onClick={VetraiButtonClick}
                      variant="primary"
                      className="w-full !rounded-xl shadow-lg"
                    >
                      <VetraiLogoColor />
                      <div className="text-sm">Built with Vetrai</div>
                    </Button>
                  </div>
                )}
              </div>
              ...
              <div className="absolute bottom-6 left-4 hidden transition-all md:block">
                ...
                >
                  <Button
                    ...
                    onClick={VetraiButtonClick}
                  >
                    <VetraiLogoColor className="h-[18px] w-[18px] scale-150" />
                  </Button>
                </ShadTooltip>
              </div>
            )}
