...
describe("getWidgetCode", () => {
  ...
  describe("Basic widget code generation", () => {
    it("should generate widget code with API key when isAuth is false", () => {
      ...
      expect(code).toContain(
        "https://cdn.jsdelivr.net/gh/logspace-ai/vetrai-embedded-chat",
      );
      expect(code).toContain("@v1.0.7");
      expect(code).toContain("</script>");

      // Check for vetrai-chat component
      expect(code).toContain("<vetrai-chat");
    ...
    it("should generate widget code without API key when isAuth is true", () => {
      ...
      expect(code).toContain("<script");
      expect(code).toContain(
        "https://cdn.jsdelivr.net/gh/logspace-ai/vetrai-embedded-chat@v1.0.7",
      );
    ...
    it("should use formatted CDN URL when copy is true", () => {
      ...
      expect(code).toContain(
        "https://cdn.jsdelivr.net/gh/logspace-ai/vetrai-embedded-chat@v1.0.7/dist/build/static/js/bundle.min.js",
      );
  ...
  describe("Code structure", () => {
    it("should have proper HTML structure with script and vetrai-chat tags", () => {
      const code = getWidgetCode(baseOptions);
      ...
      // Check for opening and closing vetrai-chat tags
      expect(code).toContain("<vetrai-chat");
      expect(code).toContain("</vetrai-chat>");
    });

    it("should have all required attributes in vetrai-chat component", () => {
      const code = getWidgetCode(baseOptions);
