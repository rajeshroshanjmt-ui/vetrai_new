...
export default defineConfig({
  ...
  webServer: [
    {
      command:
        "uv run uvicorn --factory vetrai.main:create_app --host localhost --port 7860 --loop asyncio --log-level error --no-access-log",
      port: 7860,
      env: {
        VETRAI_DATABASE_URL: "sqlite:///./temp",
        VETRAI_AUTO_LOGIN: "true",
        VETRAI_DEACTIVATE_TRACING: "true",
