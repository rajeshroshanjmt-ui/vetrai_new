...
RUN --mount=type=cache,target=/root/.npm \
    ...
    && cp -r build /app/src/backend/vetrai/frontend \
...
LABEL org.opencontainers.image.title=vetrai
LABEL org.opencontainers.image.authors=['Vetrai']
LABEL org.opencontainers.image.licenses=MIT
LABEL org.opencontainers.image.url=https://github.com/vetrai-ai/vetrai
LABEL org.opencontainers.image.source=https://github.com/vetrai-ai/vetrai

WORKDIR /app

ENV VETRAI_HOST=0.0.0.0
ENV VETRAI_PORT=7860
ENV VETRAI_EVENT_DELIVERY=polling

USER 1000
CMD ["python", "-m", "vetrai", "run", "--host", "0.0.0.0", "--backend-only"]
