  ...
  docs: [
    {
      ...
      items: [
        {
          type: "doc",
          id: "Get-Started/about-vetrai",
          label: "About Vetrai"
        },
        {
          type: "doc",
          id: "Get-Started/get-started-installation",
          label: "Install Vetrai"
        },
        {
          type: "doc",
          ...
          items: [
            {
              ...
              label: "Trigger flows with the Vetrai API"
            },
            {
              type: "doc",
              id: "Flows/webhook",
      ...
      items: [
        {
          ...
          label: "Vetrai deployment overview"
        },
        {
          type: "doc",
          id: "Deployment/deployment-public-server",
          label: "Deploy a public Vetrai server"
        },
        {
          type: "doc",
          id: "Deployment/deployment-nginx-ssl",
          label: "Deploy Vetrai with Nginx and SSL"
        },
        {
          type: "category",
          ...
          items: [
            "Deployment/develop-application",
            {
              ...
              label: "Vetrai Docker images"
            },
            {
              type: "doc",
              id: "Deployment/deployment-caddyfile",
              label: "Deploy Vetrai on a remote server"
            },
            {
              type: "category",
              label: "Kubernetes",
      ...
      items: [
        {
          ...
          label: "Get started with the Vetrai API",
        },
        {
          type: "doc",
        ...
        {
          type: "link",
          label: "Vetrai API specification",
          href: "/api",
        },
      ],
    },
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: "doc",
          id: "Support/luna-for-vetrai",
          label: "IBM Elite Support for Vetrai",
        },
        {
          type: "doc",
    ...
    },
    {
      ...
      value: `
        <a href="https://www.vetrai.org/desktop" target="_blank" class="menu__link">
          ...
          <div class="sidebar-ad-text-container">
            ...
            <span class="sidebar-ad-text sidebar-ad-text-gradient">Download Vetrai Desktop</span>
          </div>
        </a>
      `,
    },
