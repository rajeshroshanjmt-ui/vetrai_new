...
To integrate with Vetrai, add your LangWatch API key as a Vetrai environment variable:

1. Get a LangWatch API key from your LangWatch account.

2. Add the key to your Vetrai `.env` file:
...
3. Restart Vetrai with your `.env` file, if you modified the Vetrai `.env`:
