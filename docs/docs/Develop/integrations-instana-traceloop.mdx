...
description: Instrument Vetrai with the Traceloop SDK, and export traces and metrics to Instana using OpenTelemetry.
---
...
This guide demonstrates how to integrate the Instana observability platform with your Vetrai application using the Traceloop SDK so you can monitor and analyze LLM performance.
...
1. In the root folder of your Vetrai application, edit your existing Vetrai `.env` file or create a new one.
...
## Start Vetrai with Traceloop environment variables

Launch your Vetrai application with your `.env` file:
...
1. Run a flow in Vetrai to generate traffic.
2. To view traces in Instana, open Instana and click **Applications**.
3. In **Services**, search for `Vetrai`.
4. Click **Vetrai** to view and analyze the associated calls.
