...
Follow these best practices when submitting a template to Vetrai.

For template formatting examples, see [`/starter_projects`](https://github.com/vetrai-ai/vetrai/tree/main/src/backend/base/vetrai/initial_setup/starter_projects) in the Vetrai repository.

## Create a PR to submit your template

Follow these steps to submit your template:

1. Fork the [Vetrai repository](https://github.com/vetrai-ai/vetrai) on GitHub.
...
4. Create a Pull Request (PR) from your fork to the main Vetrai repository.
5. Include a screenshot of your template in the PR.

The Vetrai team will review your PR, offer feedback, and, if approved, merge the template.
...
Don't use custom components that aren't part of the Vetrai codebase.
...
For more information, see the Vetrai repository's [template categories](https://github.com/vetrai-ai/vetrai/blob/main/src/frontend/src/modals/templatesModal/index.tsx#L27-L57).