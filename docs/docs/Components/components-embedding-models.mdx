...
Embedding model components in Vetrai generate text embeddings using a specified Large Language Model (LLM).

Vetrai includes an **Embedding Model** core component that has built-in support for some LLMs.
