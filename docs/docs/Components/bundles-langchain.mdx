...
To replace these components, consider other components in the **LangChain** bundle or general Vetrai components, such as the [**Agent** component](/components-agents) or the [**SQL Database** component](/sql-database).