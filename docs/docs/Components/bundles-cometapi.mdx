...
description: Use CometAPI models in Vetrai to generate text or output a Language Model for downstream Components.
---

import Icon from "@site/src/components/icon";

[Bundles](/components-bundle-components) contain custom components that support specific third-party integrations with Vetrai.
...
3. In Vetrai, add the **CometAPI** component to your flow.
