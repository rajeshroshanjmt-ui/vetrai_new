...
:::tip
The ALTK contains features called _components_. These are different from Vetrai components. All components within ALTK are available through Vetrai's **ALTK Agent** component.
:::
...
For an example of the ALTK component in Vetrai, see the video tutorial [ALTK in Vetrai: Reliably handle JSON responses in your AI agent](https://www.youtube.com/watch?v=YNwPBK_KxXY).
