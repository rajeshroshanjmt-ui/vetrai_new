...
const config = {
  title: "Vetrai Documentation",
  tagline:
    "Vetrai is a low-code app builder for RAG and multi-agent AI applications.",
  favicon: "img/favicon.ico",
  url: "https://docs.vetrai.org",
  baseUrl: process.env.BASE_URL ? process.env.BASE_URL : "/",
  onBrokenLinks: "throw",
  onBrokenAnchors: "warn",
  organizationName: "vetrai",
  projectName: "vetrai",
  trailingSlash: false,
        ...
        redirects: [
          {
            to: "/",
            from: [
              "/whats-new-a-new-chapter-vetrai",
              "/👋 Welcome-to-Vetrai",
              "/getting-started-welcome-to-vetrai",
              "/guides-new-to-llms",
              "/about-vetrai",
            ],
          },
          ...
          },
          {
            to: "/bundles-google",
            from: [
              "/integrations-setup-google-oauth-vetrai",
              "/integrations-google-big-query",
            ],
          },
          {
            to: "/bundles-vertexai",
            from: "/integrations-setup-google-cloud-vertex-ai-vetrai",
          },
          {
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            position: "right",
            href: "https://github.com/vetrai-ai/vetrai",
            ...
            'data-platform-title': 'Vetrai'
          },
          {
            position: "right",
            href: "https://twitter.com/vetrai_ai",
            ...
            items: [
              {
                html: `<div class="footer-links">
                  <span>© ${new Date().getFullYear()} Vetrai</span>
